...
np.savetxt('./result/HMDAD_prob_matrix_avg.csv', prob_matrix_avg, delimiter='\t',fmt='%0.5f')  # HMDAD peryton Disbiome
...
model_precisions = [mean_precision, mean_precision_disbiome, mean_precision_peryton]
model_recalls = [mean_recall, mean_recall_disbiome, mean_recall_peryton]
model_auprs = [sk_average_precisions, sk_average_precisions_disbiome, sk_average_precisions_peryton]
...
model_tprs = [mean_tpr, mean_tpr_disbiome, mean_tpr_peryton]
model_fprs = [mean_fpr, mean_fpr_disbiome, mean_fpr_peryton]
model_aucs = [sk_aucs, sk_aucs_disbiome, sk_aucs_peryton]
