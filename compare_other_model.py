...
# 模型1: MGMDA
data_mvg = np.load('compare_model_my.npz')
plt.plot(data_mvg['mean_fpr'], data_mvg['mean_tprs'], label=f'MGMDA (AUC = {data_mvg["mean_auc"]:.2f})', lw=line_width, color=colors[0])
...
# 模型1: MGMDA
plt.plot(data_mvg['mean_recall'], data_mvg['mean_precisions'], label=f'MGMDA (AUPR = {data_mvg["mean_average_precision"]:.2f})', lw=line_width, color=colors[0])
